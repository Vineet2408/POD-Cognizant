...
import com.cognizant.iptm.model.SamplePatient;
...
public class TreatmentPlanDaoImpl implements TreatmentPlanDao {
	...
	@Override
	public TreatmentPlan getTreatmentPlan(SamplePatient sd) {
		...
		if (tpn.equalsIgnoreCase("package1")||tpn.equalsIgnoreCase("package 1")) {
		...
		TreatmentPlan treatmentPlan = new TreatmentPlan(0, patientDetail, patientDetail.getTreatmentPackage(),
				testDetail, "In Progress", cost, specialist, currentDate, endDate);
